...
func NewCiphertextRecordHeader(hasCID bool, has16bitSeqNum bool, hasLength bool, epoch uint16) CiphertextHeader {
	result := CiphertextHeader{FirstByte: 0b00100000 | (byte(epoch) & 0b00000011)}
	if hasCID {
...
func (hdr *CiphertextHeader) HasCID() bool         { return hdr.FirstByte&0b00010000 != 0 }
func (hdr *CiphertextHeader) Has16BitSeqNum() bool { return hdr.FirstByte&0b00001000 != 0 }
func (hdr *CiphertextHeader) HasLength() bool      { return hdr.FirstByte&0b00000100 != 0 }
func (hdr *CiphertextHeader) Epoch() byte          { return hdr.FirstByte & 0b00000011 }

func (hdr *CiphertextHeader) MatchesEpoch(epoch uint16) bool {
...
func (hdr *CiphertextHeader) ClosestSequenceNumber(seqNumData []byte, expectedSN uint64) (uint16, uint64) { // return garbage before decryption or after encryption
...
func (hdr *CiphertextHeader) Parse(datagram []byte, cIDLength int) (n int, cid []byte, seqNum []byte, header []byte, body []byte, err error) {
