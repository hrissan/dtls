...
type Stats interface {
	...
	MustNotBeFragmented(kind string, message string, addr netip.AddrPort, header format.MessageFragmentHeader)
	MustBeEncrypted(kind string, message string, addr netip.AddrPort, header format.MessageFragmentHeader)
	MustNotBeEncrypted(kind string, message string, addr netip.AddrPort, header format.MessageFragmentHeader)
...
func (s *StatsLog) MustNotBeFragmented(kind string, message string, addr netip.AddrPort, header format.MessageFragmentHeader) {
	if s.level.Load() < 0 {
		return
	}
...
func (s *StatsLog) MustBeEncrypted(kind string, message string, addr netip.AddrPort, header format.MessageFragmentHeader) {
	if s.level.Load() < 0 {
		return
	}
...
func (s *StatsLog) MustNotBeEncrypted(kind string, message string, addr netip.AddrPort, header format.MessageFragmentHeader) {
	if s.level.Load() < 0 {
		return
	}
