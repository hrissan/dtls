...
func (conn *Connection) receivedServerHelloFragment(opts *Options, fragment handshake.Fragment, rn record.Number) error {
	conn.mu.Lock()
...
func (hctx *handshakeContext) generateClientHello(conn *Connection, setEpoch1Keys bool, opts *Options, setCookie bool, ck []byte) handshake.Message {
