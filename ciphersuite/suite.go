...
type Suite interface {
	...
	NewHasher() hash.Hash         // used for transcript hash for handshake
	NewHMAC(key []byte) hash.Hash // used for HKDF and such
	ComputeSymmetricKeys(k *SymmetricKeys, secret []byte)
}
